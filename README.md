...
4.	Store file output; qemu-riscv64 ./testing/unit-test/file-name > ./testing/expected-outputs/file-name.txt
5.	Run the automated tester, make sure you are in the ./testing directory; python3 test.py
